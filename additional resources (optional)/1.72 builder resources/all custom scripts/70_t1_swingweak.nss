//::///////////////////////////////////////////////
//:: Weak Swinging Blade Trap
//:: 70_t1_swingweak
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
twice 1d8 damage, reflex save vs DC 10, evasion allowed
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    nDamage = GetSavingThrowAdjustedDamage(d8(1), oTarget, 10, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP, OBJECT_SELF);
