//::///////////////////////////////////////////////
//:: Minor Swinging Blade Trap
//:: 70_t1_swingminor
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
twice 2d8 damage, reflex save vs DC 16, evasion allowed
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int nDamage = GetSavingThrowAdjustedDamage(d8(2), oTarget, 16, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP, OBJECT_SELF);
    ...
    nDamage = GetSavingThrowAdjustedDamage(d8(2), oTarget, 16, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP, OBJECT_SELF);
