//::///////////////////////////////////////////////
//:: Adjustable Acid Blob
//:: 70_t1_acidadjst
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
Adjustable single target acid trap. Reflex save vs paralyse, acid damage without save.
...
void main()
{
    ...
    if(nDuration > 0 && (nDC < 1 || !MySavingThrow(SAVING_THROW_REFLEX, oTarget, nDC, SAVING_THROW_TYPE_TRAP)))
    {
        //Apply Hold
