...
//:://////////////////////////////////////////////
/*
twice 20d8 damage, reflex save vs DC 35, evasion allowed
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int nDamage = GetSavingThrowAdjustedDamage(d8(20), oTarget, 35, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP, OBJECT_SELF);
    ...
    nDamage = GetSavingThrowAdjustedDamage(d8(20), oTarget, 35, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP, OBJECT_SELF);
