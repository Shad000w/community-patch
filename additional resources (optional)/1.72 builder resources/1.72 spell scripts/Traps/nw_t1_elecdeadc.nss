...
void main()
{
    ...
    int nDamage = GetSavingThrowAdjustedDamage(d6(30), oTarget, nSaveDC, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP);
    ...
    while (GetIsObjectValid(o2ndTarget) && nCount < nSecondary)
    {
        ...
        {
            //Adjust the trap damage based on the feats of the target
            nDamage = GetSavingThrowAdjustedDamage(d6(30), o2ndTarget, nSaveDC, SAVING_THROW_REFLEX, SAVING_THROW_TYPE_TRAP);
