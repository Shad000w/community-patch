...
/*
Patch 1.72
- improved lvl 30 song attack bonus, damage, will, fort and reflex by +1 from balance reasons
Patch 1.70
- bard who used curse song on others will no longer be immune to the curse song
from another bard
*/
...
int IsUnderCursedSongInfluence(object oTarget);
...
void main()
{
    ...
    eDamage = EffectDamageDecrease(nDamage, DAMAGE_TYPE_BLUDGEONING|DAMAGE_TYPE_SLASHING|DAMAGE_TYPE_PIERCING);
...
effect e = GetFirstEffect(oTarget);
 ...
 {
  if(GetEffectSpellId(e) == nId && GetEffectCreator(e) != oTarget)
  {
  return TRUE;
  }
