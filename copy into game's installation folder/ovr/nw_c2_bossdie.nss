...
/*
Patch 1.72
- fixed loot not being personalized correctly in case the npc was killed by trap
*/
...
void main()
{
    ...
    if (GetIsObjectValid(oKiller) == TRUE)
    {
        ...
        else if(GetObjectType(oKiller) == OBJECT_TYPE_TRIGGER)//1.72: support for killing via trap
        {
