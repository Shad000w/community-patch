...
/*
Patch 1.72
- prevented creatures with no hands to open blocking doors
*/
...
void main()
{
    ...
    if(GetAbilityScore(OBJECT_SELF, ABILITY_INTELLIGENCE) >= 5 && Get2DAString("appearance","HASARMS",GetAppearanceType(OBJECT_SELF)) == "1")
    {
