...
void main()
{
    ...
    if (nMatch == -1) {
        ...
        {
            SetCommandable(TRUE);                               //1.72: switch allowing to control OC henchman inventory
            bkRespondToHenchmenShout(oShouter, nMatch, oIntruder, !GetModuleSwitchValue("71_MANAGE_OC_HENCHMAN_INVENTORY"));
        }
    }
